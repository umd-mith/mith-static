  ...
  <Layout>
    ...
    <div className="page-values">
      <section className="leader">
        ...
        <p>We acknowledge that inclusivity is more than just making others feel welcome. It also requires giving regular attention to working for justice by changing systems and structures of privilege and power in which we are embedded. This means recognizing or respecting silences in the cultural record and seeking to collaborate with underrepresented communities.</p>
      </section>
    </div>
  </Layout>
)
