  ...
  <Layout>
    ...
    <div className="page-home columns">
      <section className="leader"> 
        ...
        <p>The MITH website is currently being redeveloped in public. If you are looking for content that was previously here, it's in <a href="https://archive.mith.umd.edu/">the archive</a>.</p>
      </section>
    </div>
  </Layout>
)
